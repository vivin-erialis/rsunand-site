...
Route::prefix('admin')->middleware('auth')->group(function () {
    ...
    // slider
    Route::get('/slider', [DireksiController::class, 'indexDireksi']);
    Route::post('/slider', [DireksiController::class, 'saveDireksi']);
    Route::get('/slider/{id}/edit', [DireksiController::class, 'getDataforEdit']);
    Route::put('/slider/{id}/status', [DireksiController::class, 'editStatus']);
    Route::put('/slider/{id}', [DireksiController::class, 'updateDireksi']);
    Route::delete('/slider/{id}', [DireksiController::class, 'hapusDireksi']);
