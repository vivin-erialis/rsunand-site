...
// Fasilitas
Route::get('layanan-lainnya/{id}', [FasilitasController::class, 'fasilitas']);
...
Route::prefix('admin')->middleware('auth')->group(function () {
    ...
    // fasilitas
    Route::get('/fasilitas', [DireksiController::class, 'indexDireksi']);
    Route::post('/fasilitas', [DireksiController::class, 'saveDireksi']);
    Route::get('/fasilitas/{id}/edit', [DireksiController::class, 'getDataforEdit']);
    Route::put('/fasilitas/{id}/status', [DireksiController::class, 'editStatus']);
    Route::put('/fasilitas/{id}', [DireksiController::class, 'updateDireksi']);
    Route::delete('/fasilitas/{id}', [DireksiController::class, 'hapusDireksi']);
