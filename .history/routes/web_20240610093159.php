...
// Layanan
Route::get('layanan-unggulan', [FrontendLayananController::class, 'tentangKami']);
Route::get('jadwal-dokter', [FrontendLayananController::class, 'jadwalDokter']);
Route::get('informasi-dokter', [FrontendLayananController::class, 'informasiDokter']);
Route::get('bagian-instalasi', [FrontendLayananController::class, 'bagianInstalasi']);
Route::get('bagian-instalasi/{id}', [FrontendLayananController::class, 'detailBagianInstalasi']);
