...
Route::get('jadwal-dokter', [FrontendLayananController::class, 'layananPenunjang']);
Route::get('informasi-dokter', [FrontendLayananController::class, 'layananRajal']);
Route::get('bagian-instalasi', [FrontendLayananController::class, 'layananLainnya']);
Route::get('layanan-unggulan/{id}', [FrontendLayananController::class, 'detailBagianInstalasi']);
Route::get('layanan-penunjang/{id}', [FrontendLayananController::class, 'detailBagianInstalasi']);
Route::get('layanan-rajal/{id}', [FrontendLayananController::class, 'detailBagianInstalasi']);
Route::get('layanan-lainnya/{id}', [FrontendLayananController::class, 'detailBagianInstalasi']);
