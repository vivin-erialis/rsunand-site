...
Route::get('detail-layanan-unggulan/{id}', [FrontendLayananController::class, 'detailLayananUnggulan']);
Route::get('detail-layanan-penunjang/{id}', [FrontendLayananController::class, 'detailLayananPenunjang']);
Route::get('detail-layanan-rajal/{id}', [FrontendLayananController::class, 'detailLayananRajal']);
Route::get('detail-layanan-lainnya/{id}', [FrontendLayananController::class, 'detailLayananLainnya']);
