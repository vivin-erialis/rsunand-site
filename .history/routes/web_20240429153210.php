...
Route::get('jadwal-dokter', [\App\Http\Controllers\Frontend\InformasiController::class, 'jadwalDokter']);
Route::get('informasi-dokter', [\App\Http\Controllers\Frontend\InformasiController::class, 'informasiDokter']);
Route::get('bagian-instalasi', [\App\Http\Controllers\Frontend\InformasiController::class, 'bagianInstalasi']);
