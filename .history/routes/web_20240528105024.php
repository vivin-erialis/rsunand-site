...
Route::prefix('admin')->middleware('auth')->group(function () {
    ...
    // direksi
    Route::get('/direksi', [BackendArtikelController::class, 'indexDireksi']);
    Route::post('/direksi', [BackendArtikelController::class, 'saveDireksi']);
    ...
    Route::put('/direksi/{id}', [BackendArtikelController::class, 'updateDireksi']);
    Route::delete('/direksi/{id}', [BackendArtikelController::class, 'hapusDireksi']);
