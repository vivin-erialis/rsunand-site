...
Route::prefix('admin')->middleware('auth')->group(function () {
    ...
    // fasilitas
    Route::get('/fasilitas', [BackendFasilitasController::class, 'indexDireksi']);
    Route::post('/fasilitas', [BackendFasilitasController::class, 'saveDireksi']);
    Route::get('/fasilitas/{id}/edit', [BackendFasilitasController::class, 'getDataforEdit']);
    Route::put('/fasilitas/{id}', [BackendFasilitasController::class, 'updateDireksi']);
    Route::delete('/fasilitas/{id}', [BackendFasilitasController::class, 'hapusDireksi']);
