...
Route::prefix('admin')->middleware('auth')->group(function () {
    ...
    // slider
    Route::get('/slider', [DireksiController::class, 'indexSlider']);
    Route::post('/slider', [DireksiController::class, 'saveSlider']);
    ...
    Route::put('/slider/{id}', [DireksiController::class, 'updateSlider']);
    Route::delete('/slider/{id}', [DireksiController::class, 'hapusSlider']);
