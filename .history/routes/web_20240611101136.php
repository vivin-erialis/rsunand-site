...
Route::prefix('admin')->middleware('auth')->group(function () {
    ...
    // video
    Route::get('/video', [DireksiController::class, 'indexDireksi']);
    Route::post('/video', [DireksiController::class, 'saveDireksi']);
    Route::get('/video/{id}/edit', [DireksiController::class, 'getDataforEdit']);
    Route::put('/video/{id}/status', [DireksiController::class, 'editStatus']);
    Route::put('/video/{id}', [DireksiController::class, 'updateDireksi']);
    Route::delete('/video/{id}', [DireksiController::class, 'hapusDireksi']);
...
Route::get('/get-data-video', [VideoController::class, 'getVideo'])->name('getVideo');
