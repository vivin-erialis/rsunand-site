...
Route::prefix('admin')->middleware('auth')->group(function () {
    ...
    //profile
    Route::get('/profile', [DokterController::class, 'indexDokter']);
    Route::post('/profile', [DokterController::class, 'saveDokter']);
    Route::get('/profile/{id}/edit', [DokterController::class, 'getDataforEdit']);
    Route::put('/profile/{id}', [DokterController::class, 'updateDokter']);
    Route::delete('/profile/{id}', [DokterController::class, 'hapusDokter']);
