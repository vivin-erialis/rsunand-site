...
Route::prefix('admin')->middleware('auth')->group(function () {
    ...
    // layanan
    Route::get('/dokter', [LayananController::class, 'indexLayanan']);
    Route::post('/dokter', [LayananController::class, 'saveLayanan']);
    Route::get('/dokter/{id}/edit', [LayananController::class, 'getDataforEdit']);
    Route::put('/dokter/{id}', [LayananController::class, 'updateLayanan']);
    Route::delete('/dokter/{id}', [LayananController::class, 'hapusLayanan']);
});
...
Route::get('/get-data-layanan', [SliderController::class, 'getSlider'])->name('getSlider');
