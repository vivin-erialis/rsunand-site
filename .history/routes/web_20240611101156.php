...
Route::prefix('admin')->middleware('auth')->group(function () {
    ...
    // video
    Route::get('/video', [BackendVideoController::class, 'indexDireksi']);
    Route::post('/video', [BackendVideoController::class, 'saveDireksi']);
    Route::get('/video/{id}/edit', [BackendVideoController::class, 'getDataforEdit']);
    Route::put('/video/{id}', [BackendVideoController::class, 'updateDireksi']);
    Route::delete('/video/{id}', [BackendVideoController::class, 'hapusDireksi']);
