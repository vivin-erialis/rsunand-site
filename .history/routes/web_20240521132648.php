...
Route::prefix('admin')->middleware('auth')->group(function () {
    ...
    Route::get('/artikel', [BackendArtikelController::class, 'getDataArtikel'])->name('get.data.artikel');
...
// ajax
Route::get('/get-data-artikel', [ArtikelController::class, 'getArtikel'])->name('get.artikel');
