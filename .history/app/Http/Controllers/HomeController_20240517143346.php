...
class HomeController extends Controller
{
    ...
    public function getHomeContent()
    {
        ...
        return response()->json([
            'bagianInstalasi' => view('Frontend.partials.bagianInstalasi', compact('bagianInstalasi'))->render(),
            'artikel' => view('Frontend.partials.artikel', compact('artikelBerita'))->render(),
        ]);
    }
