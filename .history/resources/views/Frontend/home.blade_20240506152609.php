                ...
                <div class="container">
                    <div class="row justify-content-start">
                        <div class="col-10 col-lg-12 text-center">
                            <h4 class="display-1 text-primary animated slideInDown" style="font-size: 64px !important">Rumah Sakit Pendidikan Universitas Andalas</h4>
                            <p class="fs-7 fw-medium text-primary mb-4 pb-3">"Bekerja dengan Ilmu, Amal, dan Spiritual Demi Kemaslahatan Pasien"</p>
