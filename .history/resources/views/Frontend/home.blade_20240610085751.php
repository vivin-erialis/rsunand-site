    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s"
                >
                <div class="service-item d-flex position-relative text-center h-100" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.3); border-radius:10px">
                    @if ($item->gambar)
                        @php
                    ...
                    <div class="service-text p-5">
                        <i class="fa fa-hospital flex-shrink-0 mb-4"
                            style="color: #1C7C3D; font-size: 35px"></i>
                        <h3 class="mb-3">{{ $item->nama_layanan }}</h3>
                        <p class="mb-4">{{ Str::limit($item->desc, 80, '...') }}.</p>
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="d-flex align-items-start">
                                <i class="fa fa-star flex-shrink-0" style="color: #1C7C3D; font-size: 25px">
                                </i>
                                <div class="ms-4">
