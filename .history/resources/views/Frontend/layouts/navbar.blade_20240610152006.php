<nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
    <a href="/" class="navbar-brand ms-4 ms-lg-0">
        <h2 class="text-primary m-0"><img class="me-3" style="width: 50px" src="/../assets/img/rsunandlogo.png"
                alt="Icon">RSP Universitas Andalas</h2>
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto p-4 p-lg-0">
            ...
            <a href="/tentang-kami" class="nav-item nav-link  {{ Request::is('tentang-kami') ? 'active' : '' }}">About us</a>
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu border-0 m-0">
                   ...
                   <a href="/fasilitas/{{$item->id}}" class="dropdown-item mt-0">{{$item->nama}}</a>
                   @endforeach
                </div>
            </div>
            <a href="/pendidikan-penelitian" class="nav-item nav-link  {{ Request::is('pendidikan-penelitian') ? 'active' : '' }}">Pendidikan dan Penelitian</a>
