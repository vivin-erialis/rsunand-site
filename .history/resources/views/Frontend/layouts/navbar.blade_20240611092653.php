    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto p-4 p-lg-0">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu border-0 m-0 d-flex">
                    <div>
                        <strong style="color: #1C7C3D">Tentang Kami</strong>
                    ...
                    <div>
                        <strong style="color: #1C7C3D">Manajemen</strong>
                        <a href="/layanan-unggulan" class="dropdown-item">Direksi</a>
