                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
                                <h3 class="display-1 text-white animated slideInDown">SELAMAT DATANG DI RUMAH SAKIT PENDIDIKAN UNIVERSITAS ANDALAS PADANG</h3>
            ...
            <div class="owl-carousel-item position-relative" data-dot="<img src='/../assets/img/slide-2.jpg'>">
                ...
                <div class="owl-carousel-inner">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
                                <h3 class="display-1 text-white animated slideInDown">RUMAH SAKIT PENDIDIKAN UNIVERSITAS ANDALAS PADANG</h3>
