                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="dropdown-menu border-0 m-0">
                            <strong class="dropdown-item">Tentang RS Unand</strong>
                            <div class="dropdown-menu border-0 m-0">
                                <a href="/jadwal-doker" class="dropdown-item">Sejarah</a>
                                <a href="/informasi-dokter" class="dropdown-item">Visi & Misi</a>
                                <a href="/kamar" class="dropdown-item">Milstone</a>
                            </div>
                        </div>
                    </div>
