        ...
        <div class="navbar-nav ms-auto p-4 p-lg-0">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu border-0 m-0">
                    <a href="/layanan" class="dropdown-item">Layanan Unggulan</a>
                    <a href="/informasi-dokter" class="dropdown-item">Layanan
                        rawat Jalan</a>
                    <a href="/kamar" class="dropdown-item">Layanan Penunjang</a>
                    <a href="/bagian-instalasi" class="dropdown-item">Layanan Lainnya</a>
