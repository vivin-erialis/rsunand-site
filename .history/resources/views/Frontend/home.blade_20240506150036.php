            ...
            <div class="owl-carousel-inner">
                <div class="container">
                    <div class="row justify-content-start">
                        <div class="justify-content-center col-10 col-lg-5 home-img">
                            <h4 class="display-1 text-white animated slideInDown" style="font-size: 60px !important">Rumah Sakit Pendidikan Universitas Andalas</h4>
