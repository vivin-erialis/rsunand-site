        ...
        <div class="container">
            ...
            <div class="row g-4">
                @foreach ($layanan as $item)
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item d-flex position-relative text-center h-100 bg-secondary">
                            @if ($item->gambar)
                                @php
                            ...
                            <div class="service-text p-5">
                                <i class="fa fa-star flex-shrink-0 mb-4" style="color: #eed620; font-size: 35px; "></i>
