                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-12 text-center">
                                <h4 class="display-1 text-white animated slideInDown" style="font-size: 64px !important">
                                    Rumah Sakit Pendidikan Universitas Andalas</h4>
                                <p class="fs-7 fw-medium text-white mb-4 pb-3">"Bekerja dengan Ilmu, Amal, dan Spiritual
                                    Demi Kemaslahatan Pasien"</p>
                                <a href="/tentang-kami" class="py-3 px-5 btn-home fs-7 mt-3">SELENGKAPNYA</a>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="owl-carousel-item position-relative" data-dot="<img src='/../assets/img/slide-1.jpeg'>">
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <p class="mb-4">Perencanaan rumah sakit ini telah dimulai sejak tahun 2006 yang berkaitan dengan adanya kebijakan untuk pendirian rumah sakit perguruan tinggi dan terbatasnya fasilitas pendidikan di rumah sakit pendidikan utama di RS. M. Djamil, Padang.</p>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item d-flex position-relative text-center h-100">
                            ...
                            <div class="service-text p-5">
                                ...
                                <a class="btn" href=""><i
                                        class="fa fa-plus text-primary me-3"></i>SELENGKAPNYA</a>
                            </div>
                        </div>
                    </div>
                @empty
                    <h4 class="mt-5 text-center">Data Belum Tersdia</h4>
                @endforelse
