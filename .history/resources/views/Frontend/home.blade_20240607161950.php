                ...
                @foreach ($layanan as $item)
                    <div class="card">
                        ...
                        <div class="card-content text-center">
                            ...
                            <a href="/layanan/{{ $item->url }}">
                                <h2 class="card-title" style="color: #1C7C3D">{{ $item->nama_layanan }}</h2>
                            </a>
                            <a href="/layanan/{{ $item->url }}">

                                <p class="" style="color: black !important;">{{ Str::limit($item->desc, 80, '...') }}</p>
                            </a>
                            {{-- <a href="/layanan/{{ $item->url }}" class="card-button" style="color: #1C7C3D !important;">Read More</a> --}}
            ...
            <div class="row">
                                ...
                                @if ($item->gambar)
                                    ...
                                    @if (!empty($gambarPertama))
                                        <img loading="lazy" class="card-img-top"
                                            src="{{ asset('/../images/artikel/' . $gambarPertama) }}" alt="{{ $item->title }}">
                                    @endif
                                @endif
                                <div class="card-body">
                                    <div class="me-2 mb-3" style="color: #1C7C3D">
                                        ...
                                        <span style="font-size: 12px" class="post-meta-date">
                                            <i class="far fa-calendar me-2"></i>{{ Carbon\Carbon::parse($item->created_at)->isoFormat('D MMMM, Y') }}
                                        </span>
                                    </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="row news-block news-block-two-col d-flex mt-4">
                        <div class="col-6 news-block-two-col-image-wrap">
                            <a href="/berita/{{ $new->slug }}">
                                <img src="{{ asset('images/gambar/' . $new->gambar_berita) }}"
                                    class="news-image img-fluid" alt="" width="300px">
                            </a>
                        </div>

                        <div class="col-6 news-block-two-col-info">
                            <div class="news-block-title mb-2">
                                <h6 style="font-size: 16px;"><a href="/berita/{{ $new->slug }}"
                                        class="news-block-title-link">{{ $new->judul_berita }}</a>
                                </h6>
                            </div>
