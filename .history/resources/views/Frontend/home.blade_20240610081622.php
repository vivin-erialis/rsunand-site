        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    ...
                    <br>
                    <div>
                        <h2 class="mb-4" style="color: #1C7C3D">Informasi Lainnya</h2> <hr>
                        {{-- @foreach ($recentPosts as $new)
                            <div class="row news-block news-block-two-col d-flex mt-4">
                                <div class="col-5 news-block-two-col-image-wrap">
                                    <a href="/blog/{{ $new->url }}">
                        ...
                        <div class="col-12">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="ms-4">
                                    ...
                                    <p class="mb-0">Akreditasi Rumah Sakit Unand pertama kali oleh Komite Akreditasi Rumah Sakit (KARS) pada tanggal 26 Desember tahun 2018 dengan Akreditasi <strong>PARIPURNA</strong></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
