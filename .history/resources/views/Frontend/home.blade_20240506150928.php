            ...
            <div class="owl-carousel-inner ">
                <div class="container">
                    <div class="row justify-content-start">
                        <div class="col-10 col-lg-6 home-img">
                            <h4 class="display-1 text-white animated slideInDown" style="font-size: 55px !important">Rumah Sakit Pendidikan Universitas Andalas</h4>
                            <p class="fs-3 fw-medium text-white mb-4 pb-3">Bekerja dengan Ilmu, Amal, dan Spiritual Demi Kemaslahatan Pasien</p>
                            <a href="/tentang-kami" class=" py-3 px-5 btn-home">Read More</a>
                        </div>
                    </div>
                </div>
            </div>
