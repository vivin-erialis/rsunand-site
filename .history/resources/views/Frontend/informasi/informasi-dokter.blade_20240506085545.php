<!-- resources/views/Frontend/informasi/informasi-dokter.blade.php -->
    ...
    <div class="container-xxl project py-5">
        <div class="container">
            ...
            <div class="container-xxl py-5">
                <form action="/informasi-dokter" method="GET" id="form-spesialis">
            ...
            <!-- Bagian yang akan diperbarui dengan hasil AJAX -->
            <div class="container-xxl py-5" id="hasil-pencarian">
                <div class="container">
