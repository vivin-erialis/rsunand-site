                ...
                @forelse ($bagianInstalasi as $item)
                    <div class="col-lg-4 col-md-4 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item d-flex position-relative text-center h-100">
                            <img class="bg-img mt-2" src="../images/artikel/{{$item->gambar}}" alt="">
                            <div class="service-text p-3 card-dokter" style="width: 100%">
                                <img class="mb-2" style="width: 250px" src="../images/artikel/{{$item->gambar}}" alt="Icon">
                                <h5 class="mb-2">{{ $item->title }}</h5>
                                <p class="mb-2">{!! $item->desc !!}</p>
                                <a class="btn" href="/bagian-instalasi/{{$item->url}}"><i class="fa fa-plus text-primary me-3"></i>Read
                                    More</a>
                            </div>
                        </div>
                    </div>
