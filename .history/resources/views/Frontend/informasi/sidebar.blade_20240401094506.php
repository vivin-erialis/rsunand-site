<div class="col-lg-3">
    <div class="dropdown">
        ...
        <ul class="nav nav-pills d-flex justify-content-between w-100 h-100 me-4">
            <li class="nav-link w-100 d-flex align-items-center text-start mb-2 active" data-bs-toggle="pill" data-bs-target="#tab-pane-1" type="button">
                <h3 style="font-size: 16px" class="m-0">Dokter Umum</h3>
            </li>
            <li class="nav-link w-100 d-flex align-items-center text-start mb-2" data-bs-toggle="pill" data-bs-target="#tab-pane-2" type="button">
                <h3 style="font-size: 16px" class="m-0">Dokter Gigi & Mulut</h3>
            </li>
            <li class="nav-link w-100 d-flex align-items-center text-start mb-2" data-bs-toggle="pill" data-bs-target="#tab-pane-3" type="button">
                <h3 style="font-size: 16px" class="m-0"> Spesialis Jantung</h3>
            </li>
            <li class="nav-link w-100 d-flex align-items-center text-start mb-2" data-bs-toggle="pill" data-bs-target="#tab-pane-4" type="button">
                <h3 style="font-size: 16px" class="m-0"> Spesialis Bedah</h3>
            </li>
            <li class="nav-link w-100 d-flex align-items-center text-start mb-0" data-bs-toggle="pill" data-bs-target="#tab-pane-5" type="button">
