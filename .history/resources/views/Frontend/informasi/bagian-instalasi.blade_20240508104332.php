...
@section('content')
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="row g-4" style="padding:2vw 6vw">
                    ...
                    <div class="col-lg-3 col-md-3 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item d-flex position-relative text-center h-100">
                            ...
                            <div class="service-text p-3 card-dokter" style="width: 100%">
                                <img class="mb-3 mt-2" style="width: 200px" src="../images/artikel/{{$item->gambar}}" alt="Icon">
                                <h5 class="mb-2">{{ $item->title }}</h5>
                                <p class="mb-2">{!! $item->desc !!}</p>
                                <a style="font-size: 12px !important" class="btn" style="padding: 5px !important" href="/bagian-instalasi/{{$item->url}}"><i class="fa fa-plus text-primary me-3"></i>
                                    SELENGKAPNYA</a>
                            </div>
                        </div>
                    </div>
