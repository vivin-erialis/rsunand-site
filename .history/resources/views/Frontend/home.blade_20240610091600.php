        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <h2 class="section-title text-center MB-3">AKREDITASI RUMAH SAKIT</h2>
                    {{-- <h class="display-5 mb-4">Rumah Sakit Pendidikan Universitas Andalas</h> --}}
                    {{-- <p class="mb-4">Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo magna dolore erat amet</p> --}}
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="d-flex align-items-start">
                                <i class="fa fa-star flex-shrink-0 mb-4"
                                    style="color: #1C7C3D; font-size: 30px; background: none; -webkit-text-stroke: 1px #1C7C3D; color: transparent;"></i>
                                </i>
                                <div class="ms-4">
