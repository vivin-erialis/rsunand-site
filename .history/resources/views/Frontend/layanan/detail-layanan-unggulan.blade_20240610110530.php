...
.slider-wrapper {
    ...
    overflow: hidden;
    width: 100%;
    margin-bottom: 20px; /* Ubah sesuai kebutuhan */
}
...
.slider-wrapper .slider-nav {
    ...
    width: 40px;
    height: 40px;
    background-color: rgba(255, 255, 255, 0.5); /* Ubah sesuai kebutuhan */
    border-radius: 50%;
    text-align: center;
    line-height: 40px;
    cursor: pointer;
...
.slider-wrapper .slider-nav:hover {
    background-color: rgba(255, 255, 255, 0.8); /* Ubah sesuai kebutuhan */
}
       </style>
