                ...
                <div class="container">
                    <div class="row justify-content-start">
                        <div class="col-10 col-lg-8">
                            ...
                            {{-- <a href="/tentang-kami" class="btn-home py-3 px-5 animated slideInLeft">Read More</a> --}}
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row g-5">
            ...
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                ...
                <a class="btn-home py-3 px-5" href="/tentang-kami">Read More</a>
            </div>
        </div>
    </div>
</div>
...
<div class="container-xxl py-5">
    <div class="container">
        ...
        <div style="text-align: center;">
            <a class="btn-home mt-4 py-3 px-5" href="/bagian-instalasi">SEE ALL</a>
        </div>
    </div>
</div>
