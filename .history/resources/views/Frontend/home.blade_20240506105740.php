            ...
            <div class="owl-carousel-inner">
                <div class="container">
                    <div class="row justify-content-start">
                            <h3 class="display-1 text-white animated slideInDown" style="color: #1C7C3D !important">Selamat Datang di Rumah Sakit Pendidikan Universitas Andalas</h3>
                        <div class="col-10 col-lg-8">
                            <h3 class="display-1 text-white animated slideInDown owl-carousel" style="color: #1C7C3D !important">Selamat Datang di Rumah Sakit Pendidikan Universitas Andalas</h3>
