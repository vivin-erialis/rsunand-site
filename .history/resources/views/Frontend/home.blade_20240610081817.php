                    ...
                    <div class="card">
                        ...
                        <div class="card-content text-center">
                            ...
                            <a href="/layanan/{{ $item->url }}">
                                ...
                                <p class="" style="color: black !important;">{{ Str::limit($item->desc, 80, '...') }}
                                </p>
                            </a>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <h4 class="section-title">AKREDITASI RUMAH SAKIT</h4>
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="ms-4">
                                    <h3>AKREDITASI 1 TAHUN 2018</h3>
                                    <p class="mb-0">Akreditasi Rumah Sakit Unand pertama kali oleh Komite Akreditasi
                                        Rumah Sakit (KARS) pada tanggal 26 Desember tahun 2018 dengan Akreditasi
                                        <strong>PARIPURNA</strong></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="ms-4">
                                    <h3>AKREDITASI 2 TAHUN 2022</h3>
                                    <p class="mb-0">Rumah Sakit Unand kembali meraih akreditasi <strong>PARIPURNA</strong> pada tanggal 3-4 November tahun 2022 oleh Lembaga Akreditasi Mutu dan Keselamatan Pasien Rumah Sakit (LAMKPRS) </p>
                                </div>
                            </div>
                        </div>
                    </div>
