                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="d-flex align-items-start">
                                <i class="fa fa-star flex-shrink-0" style="color: #1C7C3D; font-size:100px">

                                </i>
                                {{-- <img class="flex-shrink-0" src="img/icons/icon-2.png" alt="Icon"> --}}
                                <div class="ms-4">
                                    <h3>AKREDITASI TAHUN 2018</h3>
                                    <p class="mb-0" style="font-size: 15px">Akreditasi Rumah Sakit Unand pertama kali oleh Komite Akreditasi
