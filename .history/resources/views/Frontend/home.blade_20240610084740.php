        ...
        <div class="container">
            ...
            <div class="row g-4">
                @foreach ($layanan as $item)
                  <div>
                      <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s" style="border: #1C7C3D solid 5px; border-radius:10px">
                        <div class="service-item d-flex position-relative text-center h-100">
                            ...
                            <div class="service-text p-5">
                                <i class="fa fa-hospital-o flex-shrink-0 mb-4" style="color: #1C7C3D; font-size: 35px"></i>
