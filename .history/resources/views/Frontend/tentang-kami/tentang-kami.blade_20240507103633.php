                ...
                <div class="tab-content w-100">
                    ...
                    <div class="tab-pane fade" id="tab-pane-5">
                        <div class="row g-4">
                            <div class="col-md-6" style="min-height: 350px;">
                                <div class="position-relative h-100">
                                    <img class="position-absolute img-fluid w-100 h-100"  src="/../assets/img/about-2.jpeg"
                                        style="object-fit: cover;" alt="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <h1 class="mb-3">Motto</h1>
                                <p class="mb-4"><strong>"Bekerja dengan Ilmu, Amal, dan Spiritual Demi Kemaslahatan
                                        Pasien"</strong></p>
