                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <p>Menyelenggarakan pelayanan kesehatan
                                            yang berkualitas dan bermutu berbasis bukti di bidang kesehatan terutama
                                            pelayanan
                                            onkologi terpadu dan intensif untuk meningkatkan derajat kesehatan
                                            masyarakat.</p>
                                        <p>Menyelenggarakan pendidikan profesi yang
                                            berkualitas, berkarakter, dan berkesinambungan</p>
                                        <p>Menyelenggarakan penelitian kolaboratif
                                            dan penelitian translasional di bidang profesi kesehatan.</p>
                                        <p>Mengembangkan organisasi dalam
                                            meningkatkan kualitas tata kelola yang unggul (good university hospital
                                            governance),
                                            menuju tata kelola yang unggul (excellent university hospital governance),
                                            serta
                                            mampu beradaptasi dengan perubahan lingkungan strategis</p>
                                        <p>Melakukan kegiatan pengabdian masyarakat
                                            dan menjalin jaringan kerjasama yang produktif dan berkelanjutan dengan
                                            berbagai
                                            pihak baik di tingkat pemerintah maupun swasta ditingkat daerah, nasional,
                                            dan
                                            internasional.</p>
                                    </div>
                                </div>
