                    ...
                    <div class="tab-pane fade" id="tab-pane-4">
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <p><i class="fa fa-check text-primary me-2"></i>Mengembangkan sistem riset produktif yang dapat menjadi sumber pendapatan rumah sakit sekaligus pusat riset translasional di Indonesia.</p>
                                <p><i class="fa fa-check text-primary me-2"></i>Menjadi pusat pelatihan dan workshop di bidang kesehatan, khususnya Indonesia bagian Barat.</p>
                                <p><i class="fa fa-check text-primary me-2"></i>Project Management</p>
                                <p><i class="fa fa-check text-primary me-2"></i>Project Management</p>
                            </div>
                        </div>
                    </div>
