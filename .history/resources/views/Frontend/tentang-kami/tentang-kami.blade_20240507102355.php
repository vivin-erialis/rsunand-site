                    ...
                    <div class="tab-pane fade" id="tab-pane-3">
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <p><i class="fa fa-check text-primary me-3"></i>Menyelenggarakan pelayanan kesehatan
                                ...
                                <p><i class="fa fa-check text-primary me-3"></i>Menyelenggarakan pendidikan profesi yang
                                    berkualitas, berkarakter, dan berkesinambungan</p>
                                <p><i class="fa fa-check text-primary me-3"></i>Menyelenggarakan penelitian kolaboratif
                                    dan penelitian translasional di bidang profesi kesehatan.</p>
                                <p><i class="fa fa-check text-primary me-3"></i>Mengembangkan organisasi dalam
                                ...
                                <p><i class="fa fa-check text-primary me-3"></i>Melakukan kegiatan pengabdian masyarakat
