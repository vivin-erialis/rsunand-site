                ...
                <div class="tab-content w-100">
                    ...
                    <div class="tab-pane fade show active" style="padding:0px 20px" id="tab-pane-1">
                        <div class="row g-4">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <h1 class="mb-4 text-center text-primary mt-4 p-2">SEJARAH RUMAH SAKIT UNIVERSITAS ANDALAS</h1><div style="border-top: 2px solid #1C7C3D; height: 10px;"></div>
                    ...
                    <div class="tab-pane fade" id="tab-pane-4">
                        <div class="row g-4">
                            <div class="col-md-6" style="min-height: 350px;">
                                <div class="position-relative h-100">
                                    <img class="position-absolute img-fluid w-100 h-100"  src="/../assets/img/about-1.jpeg"
                    ...
                    <div class="tab-pane fade" id="tab-pane-5">
                        <div class="row g-4">
                            <div class="col-md-7" style="min-height: 350px;">
                                <div class="position-relative h-100">
                                    <img class="position-absolute img-fluid w-100 h-100"  src="/../assets/img/slide-2.jpg"
                                        style="object-fit: cover;" alt="">
                                </div>
                            </div>
                            <div class="col-md-5">
                                <h1 class="mb-3">Motto</h1>
                                <p class="mb-4 fs-7"><strong>"Bekerja dengan Ilmu, Amal, dan Spiritual Demi Kemaslahatan
                                        Pasien"</strong></p>
                                <p><i class="fa fa-check text-primary me-2"></i><strong>Ilmu</strong> <br>Mencerminkan jajaran
                                ...
                                <p><i class="fa fa-check text-primary me-2"></i><strong>Amal</strong> <br>Mencerminkan jajaran
                                        RS Universitas Andalas memiliki kemampuan mandiri, disiplin, kerja keras,
                                        efektif dan efisien.</p>
                                <p><i class="fa fa-check text-primary me-2"></i><strong>Spritual</strong> <br>Merupakan sumber
