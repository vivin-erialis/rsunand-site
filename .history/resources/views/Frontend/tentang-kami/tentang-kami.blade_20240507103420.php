                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="mb-4"><strong>"Bekerja dengan Ilmu, Amal, dan Spiritual Demi Kemaslahatan
                                        Pasien"</strong></p>
                                <p><i class="fa fa-check text-primary me-3"></i><strong>Ilmu <br>Mencerminkan jajaran
                                        RS Universitas Andalas memiliki kecerdasan dan suka berbagi, kreatif dan
                                        inovatif, berjiwa visioner dan belajar sepanjang hayat.</strong></p>
                                <p><i class="fa fa-check text-primary me-3"></i><strong>Amal <br>Mencerminkan jajaran
                                        RS Universitas Andalas memiliki kemampuan mandiri, disiplin, kerja keras,
                                        efektif dan efisien.</strong></p>
                                <p><i class="fa fa-check text-primary me-3"></i><strong>Spritual <br>Merupakan sumber
                                        ...
                                        yang dijiwai oleh kepercayaan kepada Tuhan yang Maha Kuasa.</strong></p>
