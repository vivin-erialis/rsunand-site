        ...
        <div>
            ...
            <div class="col-lg-12">
                <div class="tab-content w-100">
                    ...
                    {{-- Direksi --}}
                    <div class="tab-pane fade" style="padding:0px 20px"  id="tab-pane-2">
                        <div class="container-xxl py-5">
                            <div class="container">
                                <div class="row g-0 team-items">
                                    @forelse ($direksi as $data)
                                        <div class="col-md-3 wow fadeInUp card-dokter" data-wow-delay="0.3s">
                                            <div class="team-item position-relative">
                                                ...
                                                <div class="bg-light text-center p-4">
                                                    ...
                                                    <span class="text-primary fs-7">{{ $data->jabatan }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    @empty
                    ...
                    {{-- Visi dan Misi --}}
                    <div class="tab-pane fade" style="padding:0px 20px"  id="tab-pane-3">
                        <div class="row g-4">
                    ...
                    {{-- Tujuan --}}
                    <div class="tab-pane fade" style="padding:0px 20px"  id="tab-pane-4">
                        <div class="row g-4">
                            <div class="col-md-6" style="min-height: 350px;">
                                <div class="position-relative h-100">
                                    <img class="position-absolute img-fluid w-100 h-100"
                    ...
                    {{-- Motto --}}
                    <div class="tab-pane fade" style="padding:0px 20px"  id="tab-pane-5">
                        <div class="row g-4">
