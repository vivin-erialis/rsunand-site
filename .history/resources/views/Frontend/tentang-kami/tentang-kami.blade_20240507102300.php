                    ...
                    <div class="tab-pane fade" id="tab-pane-3">
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <p><i class="fa fa-check text-primary"></i>Menyelenggarakan pelayanan kesehatan
                                ...
                                <p><i class="fa fa-check text-primary"></i>Menyelenggarakan pendidikan profesi yang
                                    berkualitas, berkarakter, dan berkesinambungan</p>
                                <p><i class="fa fa-check text-primary"></i>Menyelenggarakan penelitian kolaboratif
                                    dan penelitian translasional di bidang profesi kesehatan.</p>
                                <p><i class="fa fa-check text-primary"></i>Mengembangkan organisasi dalam
                                ...
                                <p><i class="fa fa-check text-primary"></i>Melakukan kegiatan pengabdian masyarakat
