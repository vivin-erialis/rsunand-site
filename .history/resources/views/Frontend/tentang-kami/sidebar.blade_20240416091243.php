<div class="row g-4 wow fadeInUp" data-wow-delay="0.3s">
    <div class="col-lg-2">
        <div class="nav nav-pills d-flex justify-content-between w-100 h-100 me-4">
            <button class="nav-link w-100 d-flex align-items-center text-start p-3 mb-4 active" data-bs-toggle="pill"
                data-bs-target="#tab-pane-1" type="button">
                <h3 class="m-0">Sejarah</h3>
            </button>
            <button class="nav-link w-100 d-flex align-items-center text-start p-3 mb-4" data-bs-toggle="pill"
            ...
            <button class="nav-link w-100 d-flex align-items-center text-start p-3 mb-0" data-bs-toggle="pill"
        ...
        <div class="tab-content w-100">
            ...
            <div class="tab-pane fade show active" id="tab-pane-1">
                <div class="row g-4">
                    ...
                    <div class="">
                        <img class="position-relative img-fluid w-100 h-100" src="img/project-1.jpg"
                        style="object-fit: cover;" alt="">
