                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-5">
                                ...
                                <p class="mb-4 fs-7"><strong>"Bekerja dengan Ilmu, Amal, dan Spiritual Demi Kemaslahatan
                                        Pasien"</strong></p>
                                <p><i class="fa fa-check text-primary me-3"></i><strong>Ilmu</strong> <br>Mencerminkan jajaran
                                ...
                                <p><i class="fa fa-check text-primary me-3"></i><strong>Amal</strong> <br>Mencerminkan jajaran
                                        RS Universitas Andalas memiliki kemampuan mandiri, disiplin, kerja keras,
                                        efektif dan efisien.</p>
                                <p><i class="fa fa-check text-primary me-3"></i><strong>Spritual</strong> <br>Merupakan sumber
