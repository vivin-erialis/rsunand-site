                        ...
                        <div class="row g-4">
                            <div class="col-md-12" style="min-height: 350px;">
                                <div class="position-relative h-100">
                                    <img class="position-absolute img-fluid" style="width: 100%" src="/../assets/img/sejarah.png"
                            ...
                            <div class="col-md-12">
                                ...
                                <p style="font-size: 14px">
                                    ...
                                    pendidikan profesi
                                    kedokteran dan/atau kedokteran gigi, pendidikan berkelanjutan, dan pendidikan tenaga
                                    kesehatan
                                    lainnya. Dalam melaksanakan fungsi ini, sebuah Rumah Sakit Pendidikan harus mampu
                                    menjalankan
                                ...
                                <p style="font-size: 14px">
                                    Dengan berlakunya Undang-Undang Nomor 20 Tahun 2013 tentang Pendidikan Kedokteran
                                    yang
                                    menyatakan bahwa pendidikan profesi kedokteran di rumah sakit dilaksanakan setelah
                                    rumah sakit
                                    ditetapkan menjadi Rumah Sakit Pendidikan, mengisyaratkan bahwa dalam menjalankan
                                    fungsi
                                    pendidikan, rumah sakit harus dapat menjadi lahan pendidikan yang dapat meningkatkan
                                    kompetensi
                                    Mahasiswa yang melakukan pendidikan profesi di bidangnya.</p>

                                <p style="font-size: 14px">
                                    Didukung oleh Kebijakan Dirjen Dikti, pembagunan Fakultas kedokteran di Kampus Unand
                                    Limau Manis
                                    telah dilakukan secara bertahap. Untuk menunjang pengembangan kampus yang efektif
                                    dan efisien
                                    ...
                                    Rumah Sakit
                                    Pendidikan atau memiliki rumah sakit yang bekerja sama dengan Rumah Sakit Pendidikan
                                    dan sesuai
                                    dengan PP 93/2015 tentang konsep Rumah Sakit Pendididikan. </p>

                                <p style="font-size: 14px">
                                    Rumah Sakit Unand merupakan Rumah sakit Perguruan tinggi Negeri (RSPTN) yang berada
                                    dibawah
                                    pengelolaan Universitas Andalas. Rumah sakit yang berada di kompleks kampus Unand
                                    Limau Manis,
                                    kecamatan Pauh, kota Padang, Sumatera Barat. Rumah sakit ini berdiri di atas tanah
                                    seluas 3.5 Ha
                                    dengan luas bangunan 21.306 m2 didirikan dengan dana dari Islamic Development Bank
                                    (IDB). </p>
                                ...
                                <p style="font-size: 14px">
                                    ...
                                    pendidikan di
                                    rumah sakit pendidikan utama di RS. M. Djamil, Padang. Melalui berbagai proses dan
                                    tahapan,
                                ...
                                <p style="font-size: 14px">
                                    Rumah sakit ini dibangun dengan 200 tempat tidur serta difasilitasi dengan sarana
                                    dan prasana
                                    yang cukup lengkap yang telah disesuaikan dengan peraturan perundang-undangan yang
                                    berlaku.
                                    Fasilitas yang ada di rumah sakit ini sangat lengkap, dengan program unggulan pada
                                    penyakit
                                    keganasan dan gastrointestinal. Pelayanan meliputi pelayanan rawat jalan, pelayanan
                                    rawat inap,
                                    pelayanan kamar operasi, pelayanan UGD, instalasi farmasi, pelayanan pasien rujukan,
                                    pelayanan
