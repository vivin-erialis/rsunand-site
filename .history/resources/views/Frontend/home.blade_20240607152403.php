        ...
        <div class="owl-carousel header-carousel position-relative">
            @foreach ($slider as $slider)
                <div class="owl-carousel-item position-relative"
                    ...
                    <img class="img-fluid" src="{{ asset('images/slider/' . $slider->img) }}" alt="" style="height: 300px; object-fit: cover;">
                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            ...
                            <a href="/layanan/{{ $item->url }}">
                                <h2 class="card-title">{{ $item->nama_layanan }}</h2>
                            </a>
                            {{-- <p style="color: #1C7C3D; "><i class="fa fa-calendar me-2"></i>{{ $item->created_at->format('d F Y') }}</p> --}}
                            <p class="card-text">{!! $item->desc !!}</p>
                            <a href="/layanan/{{ $item->url }}" class="card-button">Read More</a>
                        </div>
                    </div>
                @endforeach
            </div>
