                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item d-flex position-relative text-center h-100"
                            ...
                            <div class="service-text p-5">
                                <i class="fa fa-hospital flex-shrink-0 mb-4" style="color: white; font-size: 50px"></i>
                                <h3 class="mb-3" style="color: white">{{ $item->nama_layanan }}</h3>
                                <p class="mb-4" style="font-size: 13px">{{ Str::limit($item->desc, 80, '...') }}.</p>
                                <a class="btn" href="/layanan/{{$item->url}}"><i class="fa fa-plus text-primary me-3"></i>Read
                                    More</a>
                            </div>
                        </div>
                    </div>
