<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 fixed-start " style="background-color: white !important" id="sidenav-main">
    <div class="sidenav-header" style="background-color: white !important">
        <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none"
            aria-hidden="true" id="iconSidenav"></i>
        <a class="navbar-brand d-flex align-items-center m-0"
            href="/#">
            <img src="/../assets/img/rsunandlogo.png" class="mx-2" alt="">
            <span class="font-weight-bold" style="font-size: 16px !important; color: #1C7C3D;">Admin RS Unand</span>
        </a>
    </div>
