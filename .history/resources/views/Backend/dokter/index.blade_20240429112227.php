                            ...
                            <tbody>
                                ...
                                @else
                                    @foreach ($dokter as $data)
                                        <tr>
                                            <td>
                                                <p class="text-xs px-3 mb-0">{{ $data->nama }}</p>
                                            </td>
                                            <td>
                                                <p class="text-xs px-3 mb-0">{{ $data->tempat_lahir }}</p>
                                            </td>
                                            <td>
                                                <p class="text-xs px-3 mb-0">{{ $data->tanggal_lahir }}</p>
                                            </td>
                                            <td>
                                                <div class="d-block my-auto mb-0">
                                                    <a href="dokter/{{ $data->id }}/edit" class="btn btn-sm mx-1"
