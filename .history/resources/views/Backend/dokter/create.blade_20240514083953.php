            ...
            <div class="col-12">
                <div class="card border shadow-xs mb-4">
                    ...
                    <div class="card-header">
                        <form role="form" action="/admin/dokter" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                    <label>Nama</label>
                                    ...
                                    <div class="">
                                        <button type="submit"
                                            class="btn btn-success w-13 mt-4 mb-3 float-end"> <i class="fa fa-save text-xs me-1"></i>Simpan</button>
                                    </div>
                                    <div class="">
                                        <a href="/admin/dokter"
                                                class="btn btn-danger w-13 mt-4 mb-3 float-end mx-2"> <i class="fa fa-times text-xs me-1"></i>Batal
                                        </a>
                                    </div>
                                </div>
                            </div>
