            ...
            <div class="col-12">
                <div class="card border shadow-xs mb-4">
                    ...
                    <div class="table-responsive p-0">
                        <table id="bootstrap-data-table myTables" class="table align-items-center mb-0">
                                            ...
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex align-items-center">
                                                        <img src="../images/dokter/{{ $data->foto }}" alt="{{ $data->foto }}"
                                                    ...
                                                    <div class="d-flex flex-column justify-content-center ms-1">
                                                        ...
                                                        <p class="text-xs mb-0">{{ $data->tempat_lahir }}, {{ $data->tanggal_lahir }}</p>
