  ...
  $(document).ready(function() {
    $.ajax({
        ...
        success: function(response) {
            $('#myTable tbody').empty(); // Menghapus semua baris yang ada di dalam tabel

            // Iterasi setiap artikel dan tambahkan baris baru ke dalam tabel
            response.artikel.forEach(function(artikel) {
                var newRow = `<tr>
                                <td>
                ...
                $('#myTable tbody').append(newRow); // Menambahkan baris baru ke dalam tabel
            });
        },
