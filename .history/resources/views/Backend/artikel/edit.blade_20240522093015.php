        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editArtikelForm" role="form" enctype="multipart/form-data">
                    ...
                    <input id="deskripsiArtikelHidden" name="deskripsi_artikel_hidden">
                    <input id="isiArtikelHidden" name="isi_artikel_hidden">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="mb-3">
                                <textarea id="editor" class="form-control" name="desc" placeholder="Masukkan deskripsi artikel"></textarea>
                            </div>
                            <label>Isi Artikel</label>
                            <div class="mb-3">
                                <textarea id="editor-3" class="form-control" name="isi" placeholder="Masukkan isi artikel"></textarea>
                            </div>
                            <label>Gambar</label>
