...
<script>
    $(document).ready(function() {
        $('.edit-btn').click(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Set values using CKEditor's setData method after CKEditor initialization
                    if (ClassicEditor.instances['editor-3']) {
                        ClassicEditor.instances['editor-3'].setData(response.desc);
                    }

                    if (ClassicEditor.instances['editor-4']) {
        ...
        $('#editArtikelForm').on('submit', function(e) {
            ...
            if (ClassicEditor.instances['editor-3']) {
                descValue = ClassicEditor.instances['editor-3'].getData();
            }

            if (ClassicEditor.instances['editor-4']) {
                isiValue = ClassicEditor.instances['editor-4'].getData();
            }
