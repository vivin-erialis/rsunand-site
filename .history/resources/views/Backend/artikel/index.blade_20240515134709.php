        ...
        <div class="row">
            <div class="col-12">
                <div class="card border shadow-xs mb-4">
                    ...
                    <div class="table-responsive p-0" id="bootstrap-data-table">
                        <table id="myTable" class="table align-items-center mb-0 mx-2">
                                ...
                                @else
                                    @foreach ($artikel as $data)
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs px-3 mb-0" style="font-size: 10px !important;">{!! Str::words($data->desc, '8', '...') !!}</p>
                                            </td>
                                            {{-- <td>
