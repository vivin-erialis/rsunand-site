    ...
    <div class="container-fluid py-3 px-3">
        ...
        <script>
            $(document).ready(function() {
                ...
                //     $('#editArtikelForm')[0].reset();
                //     $('.invalid-feedback').remove();
                //     $('.form-control').removeClass('is-invalid');

                //     // Lakukan AJAX request untuk mendapatkan data artikel
                //     $.ajax({
                //         url: '/artikel/' + artikelId + '/edit', // Endpoint untuk mengambil data artikel
                //         method: 'GET',
                //         success: function(response) {
                //             // Isi form modal dengan data yang diterima
                //             $('#artikelId').val(response.id);
                //             $('#judulArtikel').val(response.title);
                //             $('#editor').val(response.desc);
                //             $('#editor-3').val(response.isi);
                //             $('#kategoriArtikel').val(response.kategori_id);
                //         },
                //         error: function(xhr) {
                ...
                //             // Refresh atau update tampilan data artikel di halaman
                //         },
                //         error: function(xhr) {
