...
@section('content')
    ...
    <div class="container-fluid py-3 px-3">
        ...
        <script>
            ...
            // Dapatkan data dari CKEditor
            var desc = editorInstance1.getData();
            var isi = editorInstance3.getData();
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Refresh atau update tampilan data artikel di halaman tanpa memuat ulang halaman
                    // location.reload(); // Atau Anda bisa menggunakan AJAX untuk memperbarui tampilan data
                },
                error: function(xhr) {
