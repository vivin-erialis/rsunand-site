                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-block my-auto mb-0">
                                                    <a href="artikel/{{ $data->id }}/edit" class="btn btn-sm btn-success"
                                                       ><i class="fa fa-edit text-xs me-2"></i></a>
                                                    <a href="artikel/{{ $data->id }}" class="btn btn-sm btn-dark"
                                                        ><i class="fa fa-eye text-xs me-2"></i></a>
                                                    <form action="artikel/{{ $data->id }}" method="post"
                                                        class="d-inline">
                                                        @method('DELETE')
                                                        @csrf
                                                        <button class="btn btn-danger btn-sm" type="submit"
                                                            onclick="return confirm('Yakin akan menghapus data?')"><i class="fa fa-trash text-xs me-2"></i></button>
                                                    </form>
                                                </div>
                                            </td>
                                        </tr>
