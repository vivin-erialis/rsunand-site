    ...
    <div class="container-fluid py-3 px-3">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-block my-auto mb-0">
                                                    ...
                                                    <!-- Tautan untuk membuka modal edit -->
                                                    <a href="#" class="btn btn-primary edit-btn" data-id="{{ $artikel->id }}">Edit</a>
                                                @endforeach
        ...
        <script>
            $(document).ready(function() {
                // Handler untuk saat tombol edit di klik
                $('.edit-btn').click(function() {
                    // Ambil ID artikel dari atribut data-id
                    var artikelId = $(this).data('id');
                    // Set nilai action pada form modal untuk sesuai dengan artikel yang akan diedit
                    $('#editModal form').attr('action', '/artikel/' + artikelId);
                    // Buka modal
