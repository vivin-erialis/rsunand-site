                ...
                <form id="editArtikelForm" role="form" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="mb-3">
                                <textarea  id="deskripsiArtikelHidden" class="form-control" name="desc" placeholder="Masukkan deskripsi artikel"></textarea>
                            </div>
                            <label>Isi Artikel</label>
                            <div class="mb-3">
                                <textarea id="isiArtikelHidden" class="form-control" name="isi" placeholder="Masukkan isi artikel"></textarea>
                            </div>
                            <label>Gambar</label>
