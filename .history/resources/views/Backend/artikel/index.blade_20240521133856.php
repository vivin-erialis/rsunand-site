                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            data.forEach(function(artikel) {
                                ...
                                html += '<td><p class=" px-3 mb-0">' + artikel.title + '<br></p></td>';
                                html += '<td><p class=" px-3 mb-0">' + artikel.desc + '</p></td>';
                                html += '<td>';
                                html += '<button class="btn btn-sm btn-success edit-btn" data-id="' + artikel.id + '" data-toggle="modal" data-target="#editModal"> <i class="fa fa-edit text-xs me-2"></i> Edit</button>';
                                html += '<button class="btn btn-sm btn-success delete-btn" data-id="' + artikel.id + '" data-toggle="modal" data-target="#deleteModal"> <i class="fa fa-trash text-xs me-2"></i> Delete</button>';
                                html += '</td>';
                                html += '</tr>';
                            });
