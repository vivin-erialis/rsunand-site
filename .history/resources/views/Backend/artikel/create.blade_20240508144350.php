                        ...
                        <form role="form" action="/admin/artikel" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="">
                                        <button type="submit"
                                            class="btn btn-success w-13 mt-4 mb-3 float-end"> <i class="fa fa-save me-2"></i> Simpan</button>
                                    </div>
                                    <div class="">
                                        <a href="/admin/artikel"
                                                class="btn btn-danger w-13 mt-4 mb-3 float-end mx-2"> <i class="fa fa-times me-2"></i> Batal
                                        </a>
                                    </div>
                                </div>
                            </div>
