                    ...
                    <form id="artikelForm" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="mb-3">
                                    <input type="text" class="form-control" placeholder="masukan judul artikel"
                                        aria-label="Name" aria-describedby="name-addon" name="title" id="title"
                                        required>
                                </div>
                                ...
                                <div class="mb-3">
                                    <textarea type="text" id="editor3" placeholder="masukan isi artikel" aria-label="Name"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="">
                                    <button type="submit" class="btn btn-sm btn-success w-13 mt-4 mb-3">
                                        <i class="fa fa-save me-1 text-xs"></i> Simpan
                                    </button>
                                    <button type="button" class="btn btn-sm btn-dark w-13 mt-4 mb-3 mx-2"
                                    data-dismiss="modal">
