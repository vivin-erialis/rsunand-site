                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            response.artikel.forEach(function(article) {
                                ...
                                html += '<button class="btn btn-sm btn-danger delete-btn" data-id="' + article.id + '" data-toggle="modal" data-target="#deleteModal"> <i class="fa fa-trash text-xs me-2"></i> Hapus</button>';
                                html += '</td>';
                                html += '</tr>';
                            });
