                    ...
                    <div class="container p-3">
                        <table id="myTable" class="display">
                            <thead>
                                <tr>
                                    {{-- <th>No</th> --}}
                                    <th class="text-white text-xs font-weight-semibold opacity-7">Judul Artikel</th>
                                    {{-- <th class="text-white text-xs font-weight-semibold opacity-7 ps-2">Deskripsi --}}
                                    {{-- <th class="text-white text-xs font-weight-semibold opacity-7 ps-2">Isi --}}
                                    </th>
                                    <th class="text-white text-xs font-weight-semibold opacity-7">Deskripsi</th>
                                    <th class="text-white text-xs font-weight-semibold opacity-7">Aksi</th>
                                </tr>
                            </thead>
                            <tbody>
                                @if ($artikel->isEmpty())
                                ...
                                @else
                                    @foreach ($artikel as $data)
                                        <tr>
                                            <td>
                                                <p class="text-xs px-3 mb-0">{{ $data->title }} <br> {{$data->kategori->title}}</p>
                                            </td>
                                            <td>
                                                <p class="text-xs px-3 mb-0" style="font-size: 10px !important;">{!! $data->desc !!}</p>
                                            </td>
                                            {{-- <td>
                                            ...
                                            <td>
                                                <div class="d-block my-auto mb-0">
                                                    <a href="artikel/{{ $data->id }}/edit" class="btn btn-sm"
                                                        style="background-color:rgb(66, 66, 111); color: white;"><i class="fa fa-edit text-xs me-2"></i>Edit</a>
                                                    <a href="artikel/{{ $data->id }}" class="btn btn-sm"
                                                        style="background-color:rgb(217, 151, 60); color: white;"><i class="fa fa-eye text-xs me-2"></i>Detail</a>
