        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="tambahArtikel" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="mb-3">
                                    <input type="file" class="form-control"
                                        aria-describedby="email-addon" name="gambar[]" multiple
                                        required>
                                </div>
                                ...
                                <div class="">
                                    <button type="submit"
                                        class="btn btn-success w-13 mt-4 mb-3 float-end">
                                        <i class="fa fa-save me-1"></i> Simpan
                                    </button>
                                </div>
                                <div class="">
                                    <button type="button" class="btn btn-dark w-13 mt-4 mb-3 float-end mx-2" data-dismiss="modal">
        ...
        $('#tambahArtikel').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Optionally, reload the data or update the DOM to reflect the new data
                },
