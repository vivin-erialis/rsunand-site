    ...
    <div class="container-fluid py-3 px-3">
        ...
        <script>
            $(document).ready(function() {
                ...
                // ClassicEditor
                //     .create(document.querySelector('#deskripsiArtikelHidden'))
                //     .then(editor => {
                ...
                ClassicEditor
                    .create(document.querySelector('#isiArtikelHidden'))
                    .then(editor => {
                ...
                $('#editArtikelForm').on('submit', function(e) {
                    ...
                    var descValue = window.editor.getData();
                    var isiValue = window.editor3.getData();
