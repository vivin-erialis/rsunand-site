                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            response.artikel.forEach(function(article) {
                                html += '<tr>';
                                html +=
                                    '<td><a href="" class="btn btn-sm btn-success"><i class="fa fa-check text-xs me-2"></i>var html = ' <
                                    td > ';
                                ...
                                if (isActive) {
                                    ...
                                    html +=
                                        '<a href="" class="btn btn-sm btn-danger"><i class="fa fa-times text-xs me-2"></i>Tidak Aktif</a>';
                                }
