                                ...
                                @else
                                    @foreach ($artikel as $data)
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs px-3 mb-0">{{ $data->desc }}</p>
                                            </td>
                                            <td>
                                                <p class="text-xs px-3 mb-0">{{ $data->isi }}</p>
                                            </td>
                                            <td>
                                                <div class="d-block my-auto mb-0">
                                                    <a href="admin/artikel/{{ $data->id }}/edit" class="btn btn-sm mx-1"
                                                        style="background-color:rgb(66, 66, 111); color: white;">Edit</a>
                                                    <a href="admin/artikel/{{ $data->id }}" class="btn btn-sm mx-1"
                                                        style="background-color:rgb(217, 151, 60); color: white;">Detail</a>
                                                    <form action="admin/artikel/{{ $data->id }}" method="post"
                                                        class="d-inline">
                                                        @method('DELETE')
                                                        @csrf
