                                            ...
                                            <td>
                                                <div class="d-block my-auto mb-0">
                                                    <a href="artikel/{{ $data->id }}/edit" class="btn btn-sm mx-1"
                                                        style="background-color:rgb(66, 66, 111); color: white;"><i class="fa fa-edit text-xs"></i></a>
                                                    <a href="artikel/{{ $data->id }}" class="btn btn-sm mx-1"
                                                        style="background-color:rgb(217, 151, 60); color: white;"><i class="fa fa-eye text-xs"></i></a>
