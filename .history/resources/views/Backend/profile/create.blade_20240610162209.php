                    ...
                    <form id="artikelForm" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <label>Email</label>
                                <div class="mb-3">
                                    <input type="text" id="editor-2" placeholder="masukan email" aria-label="Name"
                                        aria-describedby="name-addon" name="email"></input>
                                </div>
                                <label>Telelpon</label>
                                <div class="mb-3">
                                    <textarea type="text" id="editor-2" placeholder="masukan telepon" aria-label="Name"
                                        aria-describedby="name-addon" name="telp"></textarea>
                                </div>
