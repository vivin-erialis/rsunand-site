                        ...
                        <table id="bootstrap-data-table" class="table align-items-center mb-0">
                            <thead class="bg-gray-100">
                                <tr>
                                    ...
                                    <th class="text-secondary text-xs font-weight-semibold opacity-7 ps-2">Tempat/Tanggal
                                        Lahir
                                ...
                                @else
                                    @foreach ($direksi as $data)
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    ...
                                                    <div class="d-flex flex-column justify-content-center ms-1">
                                                        ...
                                                        <p class="text-xs px-3 mb-0">{{ $data->jabatan }}</p>
                                            ...
                                            <td>
                                                <p class="text-xs px-3 mb-0">{{ $data->tempat_lahir }}/
                                            ...
                                            <td>
                                                <div class="d-block my-auto mb-0">
                                                    <a href="direksi/{{ $data->id }}/edit"
                                                        class="btn btn-success btn-sm mx-1" style="color: white;">Edit</a>
