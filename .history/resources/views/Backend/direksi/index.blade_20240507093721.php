                    ...
                    <div class="card-header border-bottom pb-0 mb-3">
                        <div class="d-sm-flex align-items-center">
                            ...
                            <div class="ms-auto d-flex">
                                <a href="direksi/create" class="btn btn-sm btn-dark btn-icon d-flex align-items-center me-2">
                        ...
                        <table id="bootstrap-data-table" class="table align-items-center mb-0">
                            <thead class="bg-gray-100">
                                <tr>
                                    ...
                                    <th class="text-secondary text-xs font-weight-semibold opacity-7 ps-2">Jabatan
                                    </th>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex align-items-center">
                                                        <img src="../images/direksi/{{ $data->foto }}" alt="{{ $data->foto }}"
                                            ...
                                            <td>
                                                <div class="d-block my-auto mb-0">
                                                    <a href="direksi/{{ $data->id }}/edit" class="btn btn-success btn-sm mx-1"
