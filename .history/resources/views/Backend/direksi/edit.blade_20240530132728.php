            ...
            <div class="modal-body">
                <form id="editForm" role="form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <input type="text" class="form-control" placeholder="masukan tempat lahir"
                                    aria-label="Name" aria-describedby="name-addon" id="tempatLahir"
                                    name="tempat_lahir">
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <input type="date" class="form-control" placeholder="masukan tempat lahir"
                                    aria-label="Name" aria-describedby="name-addon" id="tanggalLahir"
                                    name="tanggal_lahir">
                            </div>
                            <label>Jabatan</label>
                            <div class="mb-3">
                                <input type="text" class="form-control" id="jabatan"
                                    placeholder="masukan jabatan direksi" aria-label="Name"
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-sm btn-dark" class="close" data-dismiss="modal"
                            aria-label="Close"> <i class="fa fa-times text-xs me-1"></i>Batal</button>
                        <button type="submit" class="btn btn-sm btn-success"> <i
                                class="fa fa-save text-xs me-1"></i>Simpan</button>
                    </div>
                </form>
            </div>
        </div>
