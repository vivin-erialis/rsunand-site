            ...
            <div class="col-12">
                <div class="card border shadow-xs mb-4">
                    ...
                    <div class="card-header">
                        <form role="form" action="/admin/direksi/{{ $direksi->id }}" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        <input type="text" class="form-control" placeholder="masukan tempat lahir"
                                            aria-label="Name" aria-describedby="name-addon" name="jabatan"
                                            value="{{ $direksi->jabatan }}">
                                    </div>
                                    ...
                                    <div class="">
                                        <button type="submit"
                                            class="btn btn-success w-13 mt-4 mb-3 float-end">Simpan</button>
                                    </div>
                                    <div class="">
                                        <a href="/admin/direksi"
                                                class="btn btn-danger w-13 mt-4 mb-3 float-end mx-2">Batal
                                        </a>
                                    </div>
                                </div>
