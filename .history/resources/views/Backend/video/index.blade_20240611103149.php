                ...
                <div class="card border shadow-xs mb-4">
                    <div class="card-header border-bottom pb-0 mb-3">
                        <div class="d-sm-flex align-items-center">
                            <div>
                                <h6 class="font-weight-semibold text-lg mb-0">Data Video</h6>
                                <p class="text-sm">Data Video RS Unand</p>
                            </div>
                    ...
                    <div class="container p-3">
                        <table id="myTable" class="display">
                            <thead>
                                <tr>
                                    <th class="text-dark text-xs font-weight-semibold">Judul</th>
                                    <th class="text-dark text-xs font-weight-semibold">Video</th>
                ...
                function loadData() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            let html = '';
                            response.video.forEach(function(video) {
                                html += '<tr>';
                                html += '<td><p class="px-3 mb-0">' + video.judul + '</p></td>';
                                html += '<td><p class="px-3 mb-0">' + video.link + '</p></td>';
                                html += '<td>';
                                html +=
