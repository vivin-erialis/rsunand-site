...
<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        <div class="modal-header" style="background-color: whitesmoke;">
            <h5 class="modal-title" id="addArticleModalLabel">Tambah Data Slider</h5>
            ...
            <form id="addForm" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <label>Judul </label>
                        <div class="mb-3">
                            <input type="text" class="form-control" placeholder="masukan judul slider"
                                aria-label="Name" aria-describedby="name-addon" name="title" id="title" required>
                        </div>
                        <label>Deskripsi </label>
                        <div class="mb-3">
                            <textarea type="text" class="form-control" placeholder="masukan deskripsi slider" aria-label="Name"
                                aria-describedby="name-addon" name="desc"></textarea>
                        </div>

                        <label>Gambar</label>
                        <div class="mb-3">
                            <input type="file" class="form-control" aria-describedby="email-addon" name="img[]" multiple required>
