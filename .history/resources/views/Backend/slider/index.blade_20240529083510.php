...
@section('title', 'Halaman Data Slider')
@section('content')
        ...
        <script>
            $(document).ready(function() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            response.slider.forEach(function(slider) {
                                ...
                                html += '</td>';
                                html += '<td><p class="px-3 mb-0">' + slider.title +
                                    '<br></p></td>';
                ...
                $(document).on('click', '.delete-btn', function() {
                    var daaId = $(this).data('id');
                    console.log("Delete button clicked, daaId:", daaId); // Debugging
                    $('#deleteModal').modal('show');

                    // Saat konfirmasi hapus diklik, kirim permintaan penghapusan
                    $('#deleteBtn').off('click').on('click', function() {
                        $.ajax({
                            url: '/admin/artikel/' + daaId,
                            type: 'DELETE',
                            success: function(response) {
                                console.log(response);
