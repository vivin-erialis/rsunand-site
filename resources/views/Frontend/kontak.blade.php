            ...
            <div class="row g-2">
                <div class="col-lg-5 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="d-flex flex-column justify-content-between h-100">
                        <div class="bg-light d-flex align-items-center w-100 p-2">
                        ...
                        <div class="bg-light d-flex align-items-center w-100 p-2">
                            <div class="d-flex m-auto flex-shrink-0 align-items-center justify-content-center bg-dark"
                                style="width: 55px; height: 55px;">
                                <a class="btn btn-sm-square btn-outline-body" href="https://www.facebook.com/rumahsakitunand" target="_blank"><i
                                        class="fab fa-facebook-f"></i></a>
                            </div>
                            <div class="d-flex m-auto flex-shrink-0 align-items-center justify-content-center bg-dark"
                                style="width: 55px; height: 55px;">
                                <a class="btn btn-sm-square btn-outline-body"
                                    href="https://www.youtube.com/@rumahsakitunand4972" target="_blank"><i
                            ...
                            <div class="d-flex m-auto flex-shrink-0 align-items-center justify-content-center bg-dark"
                                ...
                                <a class="btn btn-sm-square btn-outline-body me-0"
                                    href="https://www.instagram.com/rumahsakitunand/" target="_blank"><i
                                        class="fab fa-instagram"></i></a>
                            </div>
                            <div class="d-flex m-auto flex-shrink-0 align-items-center justify-content-center bg-dark"
                                style="width: 55px; height: 55px;">
                                <a class="btn btn-sm-square btn-outline-body me-0"
                                    href="https://www.tiktok.com/@rumahsakitunand?_t=8nSR17CG3ip&_r=1" target="_blank"><i
