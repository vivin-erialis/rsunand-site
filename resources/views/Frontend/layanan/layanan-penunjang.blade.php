...
@section('content')
@section('title', 'Layanan Penunjang')
@include('Frontend.layouts.header')
<div class="container-xxl py-5">
    <div class="container">
        <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
            <h4 class="section-title">LAYANAN penunjang</h4>
                    ...
                    <div class="service-item d-flex position-relative text-center h-100" style="border-radius:10px">
                        @if ($item->gambar)
                            ...
                            @if (!empty($gambarPertama))
                                <a href="/layanan-penunjang/{{ $item->url }}">
                        ...
                        <div class="service-text p-5">
                            ...
                            <a class="btn" href="/layanan-penunjang/{{ $item->url }}"><i
